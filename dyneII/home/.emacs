...
;; uncomment the entries below to take out GUI bells and whistles:
;; Emacs is better used thru hot-keys!
;; (tool-bar-mode nil)
;; (menu-bar-mode nil)
;; (scroll-bar-mode nil)
...
(custom-set-variables
 ...
 '(toolbar-mail-reader (quote pine))
 '(user-mail-address "jaromil@kyuzz.org"))
(custom-set-faces
