...
//#define DEBUG 1
#define LOCALE_ALIAS "/usr/share/dyne/locale.alias"
#define KEYBOARD_LST "/usr/share/dyne/keyboard.lst"
                                        ...
                                        gpointer         user_data)
{
  ...
  if(!rc) {
    ...
    snprintf(tmp,256,"# generated by the dyne language configurator 2.0\n");
    fputs(tmp,rc);
